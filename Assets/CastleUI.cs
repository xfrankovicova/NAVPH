...
public class CastleUI : MonoBehaviour
{
    ...
    void Start()
    {
        Initialize("Castle", "King", "Kingdom", "100", "10", "Building1", "Building2", "Building3", "Building4", "Building5");
    }
    ...
    private void Initialize(string townName, string kingName, string kingdomName, string wealth, string freeMen,
        string buildingName1, string buildingName2, string buildingName3, string buildingName4, string buildingName5)
    {
